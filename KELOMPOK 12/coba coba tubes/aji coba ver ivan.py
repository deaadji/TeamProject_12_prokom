...
def Main_menu():
    ...
    exit_btn = tk.Button(screen1, text="Keluar", font=("century gothic", 25), fg="Red", bd=0, bg="White")
    ...
    def confirm_exit():
        exit_confirm = messagebox.askyesno('Confirm Exit', 'Are you sure you want to exit?')
        if exit_confirm:
            root.destroy()
